      ...
      <div className="image flex-col flex justify-center items-center my-10">
        ...
        <div className="para">
          <div className="text flex-col flex justify-center items-center mt-10">
            <h1 className="capitalize text-[4vw] sm:text-[1.8vw] mb-5 sm:mb-10">
              My Python work
            </h1>
            <div className="flex sm:justify-evenly items-center gap-3 flex-col sm:flex-row sm:gap-10">
              ...
              <div className="para w-[70vw]">
                <p className="text-[3vw] sm:text-[1.8vw] p-1 capitalize">
                  As an aspiring Python developer with a year of personal
                  experience, I bring a strong foundation in Python programming
                  and a passion for coding. Eager to transition from personal
                  projects to a professional setting,
            ...
            <div className="second-box mt-5 sm:mt-20 mb-10">
              <h1 className="capitalize text-[3vw] sm:text-[2vw] text-center">
